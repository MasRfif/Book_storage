...
ThemeData lightTheme(context) => ThemeData(
  ...
  dividerTheme: Theme.of(
    context,
  ).dividerTheme.copyWith(color: AppColor.dividerLight, thickness: 1, space: 1),
  appBarTheme: Theme.of(context).appBarTheme.copyWith(
    surfaceTintColor: AppColor.appBarBackgroundLight,
    backgroundColor: AppColor.appBarBackgroundLight,
    foregroundColor: Colors.black,
    shape: Border(bottom: BorderSide(color: AppColor.dividerLight, width: 0.5)),
  ),
  ...
  tabBarTheme: TabBarTheme(
    ...
    indicator: BoxDecoration(
      border: Border(
        bottom: BorderSide(width: 3, color: AppColor.primaryLight),
      ),
    ),
  ...
  textTheme: Theme.of(context).textTheme.copyWith(
    displayLarge: Theme.of(
      context,
    ).textTheme.displayLarge?.copyWith(color: AppColor.primaryLight),
    displayMedium: Theme.of(
      context,
    ).textTheme.displayMedium?.copyWith(color: AppColor.primaryLight),
    displaySmall: Theme.of(
      context,
    ).textTheme.displaySmall?.copyWith(color: AppColor.primaryLight),
    headlineLarge: Theme.of(
      context,
    ).textTheme.headlineLarge?.copyWith(color: AppColor.primaryLight),
    headlineMedium: Theme.of(
      context,
    ).textTheme.headlineMedium?.copyWith(color: AppColor.primaryLight),
    headlineSmall: Theme.of(
      context,
    ).textTheme.headlineSmall?.copyWith(color: AppColor.primaryLight),
    titleLarge: Theme.of(
      context,
    ).textTheme.titleLarge?.copyWith(color: AppColor.primaryLight),
    titleMedium: Theme.of(
      context,
    ).textTheme.titleMedium?.copyWith(color: AppColor.primaryLight),
    titleSmall: Theme.of(
      context,
    ).textTheme.titleSmall?.copyWith(color: AppColor.primaryLight),
    bodyLarge: Theme.of(
      context,
    ).textTheme.bodyLarge?.copyWith(color: AppColor.primaryLight),
    bodyMedium: Theme.of(
      context,
    ).textTheme.bodyMedium?.copyWith(color: AppColor.primaryLight),
    bodySmall: Theme.of(
      context,
    ).textTheme.bodySmall?.copyWith(color: AppColor.primaryLight),
    labelLarge: Theme.of(
      context,
    ).textTheme.labelLarge?.copyWith(color: AppColor.primaryLight),
    labelMedium: Theme.of(
      context,
    ).textTheme.labelMedium?.copyWith(color: AppColor.primaryLight),
    labelSmall: Theme.of(
      context,
    ).textTheme.labelSmall?.copyWith(color: AppColor.primaryLight),
  ),
  ...
  iconTheme: Theme.of(context).iconTheme.copyWith(color: AppColor.primaryLight),
  ...
  inputDecorationTheme: Theme.of(context).inputDecorationTheme.copyWith(
    ...
    hintStyle: TextStyle(color: AppColor.placeholderLight),
