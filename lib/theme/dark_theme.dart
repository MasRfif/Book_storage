...
import 'package:book_tracker_v9/bloc/colors.dart';
...
ThemeData darkTheme(context) => ThemeData(
  ...
  dividerTheme: Theme.of(
    context,
  ).dividerTheme.copyWith(color: AppColor.dividerDark, thickness: 1, space: 1),
  appBarTheme: Theme.of(context).appBarTheme.copyWith(
    surfaceTintColor: AppColor.appBarBackgroundDark,
    backgroundColor: AppColor.appBarBackgroundDark,
    foregroundColor: AppColor.white,
    shape: Border(bottom: BorderSide(color: AppColor.dividerDark, width: 0.5)),
  ),
  bottomNavigationBarTheme: Theme.of(context).bottomNavigationBarTheme.copyWith(
    ...
    selectedLabelStyle: Theme.of(
      context,
    ).bottomNavigationBarTheme.selectedLabelStyle?.copyWith(fontSize: 12),
  ...
  tabBarTheme: Theme.of(context).tabBarTheme.copyWith(
    ...
    indicator: BoxDecoration(
      border: Border(
        bottom: BorderSide(width: 3, color: AppColor.secondaryDark),
      ),
    ),
  ...
  listTileTheme: Theme.of(context).listTileTheme.copyWith(
    ...
    subtitleTextStyle: const TextStyle(fontSize: 14, height: 1.5),
  ),
  ...
  textTheme: Theme.of(context).textTheme.copyWith(
    displayLarge: Theme.of(
      context,
    ).textTheme.displayLarge?.copyWith(color: AppColor.primaryDark),
    displayMedium: Theme.of(
      context,
    ).textTheme.displayMedium?.copyWith(color: AppColor.primaryDark),
    displaySmall: Theme.of(
      context,
    ).textTheme.displaySmall?.copyWith(color: AppColor.primaryDark),
    headlineLarge: Theme.of(
      context,
    ).textTheme.headlineLarge?.copyWith(color: AppColor.primaryDark),
    headlineMedium: Theme.of(
      context,
    ).textTheme.headlineMedium?.copyWith(color: AppColor.primaryDark),
    headlineSmall: Theme.of(
      context,
    ).textTheme.headlineSmall?.copyWith(color: AppColor.primaryDark),
    titleLarge: Theme.of(
      context,
    ).textTheme.titleLarge?.copyWith(color: AppColor.primaryDark),
    titleMedium: Theme.of(
      context,
    ).textTheme.titleMedium?.copyWith(color: AppColor.primaryDark),
    titleSmall: Theme.of(
      context,
    ).textTheme.titleSmall?.copyWith(color: AppColor.primaryDark),
    bodyLarge: Theme.of(
      context,
    ).textTheme.bodyLarge?.copyWith(color: AppColor.primaryDark),
    bodyMedium: Theme.of(
      context,
    ).textTheme.bodyMedium?.copyWith(color: AppColor.primaryDark),
    bodySmall: Theme.of(
      context,
    ).textTheme.bodySmall?.copyWith(color: AppColor.primaryDark),
    labelLarge: Theme.of(
      context,
    ).textTheme.labelLarge?.copyWith(color: AppColor.primaryDark),
    labelMedium: Theme.of(
      context,
    ).textTheme.labelMedium?.copyWith(color: AppColor.primaryDark),
    labelSmall: Theme.of(
      context,
    ).textTheme.labelSmall?.copyWith(color: AppColor.primaryDark),
  ),
  ...
  iconTheme: Theme.of(context).iconTheme.copyWith(color: AppColor.primaryDark),
  ...
  inputDecorationTheme: Theme.of(context).inputDecorationTheme.copyWith(
    ...
    hintStyle: TextStyle(color: AppColor.placeholderDark, height: 2),
